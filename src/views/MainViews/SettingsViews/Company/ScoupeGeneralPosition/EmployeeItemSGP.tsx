...
export function EmployeeItem({Employee}:any)
{
    return(
            <View style={{...styles.container}}>
                        <Text style={{alignSelf: 'center' ,opacity: 0.65, fontSize:16, fontWeight: 'bold'}}>{Employee.FirstName} {Employee.LastName}</Text> 
            </View>
    )
}

export function EmployeeItemFull({ScoupeGeneralPosition, callbackScoupeGeneralPosition, setModalScoupeGeneralPositionVisible}:any)
{
